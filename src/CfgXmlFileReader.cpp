...
typedef std::tr1::unordered_multimap<std::string, std::string> umultimap;
...
//    std::string CfgFileReader::operator[] ( std::string key ) const
//    {
//        return get( key );
//    }
...
//    std::string CfgXmlFileReader::get(std::string key) const
//    {
...
//    std::list<std::string> CfgFileReader::keys()
//    {
//        return configKeys_;
//    }
...
//    std::string CfgFileReader::extractValue( const std::string & specification )
//    {
